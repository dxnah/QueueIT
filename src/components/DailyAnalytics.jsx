// DailyAnalytics.jsx
// Updated: Monthly dropdown with peak months, Weekly dropdown (Week 1-4), Daily calendar view
  ...
  return (
    <div className="analytics-wrapper">
      ...
      <div className="analytics-stat-chips">
        {[
          { id: 'dispensed', label: 'Total Dispensed', value: totalToday.toLocaleString(), unit: 'doses', color: '#26a69a', icon: '💉' },
          { id: 'wasted', label: 'Total Wasted', value: wastedToday.toLocaleString(), unit: 'doses', color: '#e53935', icon: '🗑️' },
