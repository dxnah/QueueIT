                      ...
                      <tbody>
                        {filtered.map((order, i) => (
                          <tr key={order.id}
                            ...
                            {/* Django saves as price_per_piece */}
                            <td style={{ padding:'12px 14px', color:'#555' }}>₱{(order.price_per_piece || order.pricePerPiece || 0).toLocaleString()}</td>
                            ...
                            <td style={{ padding:'12px 14px', color:'#666', fontSize:'12px' }}>
                              {new Date(order.ordered_at || order.orderedAt).toLocaleDateString('en-PH', { year:'numeric', month:'short', day:'numeric' })}
                            </td>
