...
const VaccineOrders = () => {
  ...
  // Load from localStorage; fall back to seed data from ordersData.jsx
  useEffect(() => {
  ...
  const counts = ORDER_STATUS_OPTIONS.reduce((acc, s) => {
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '20px', flexWrap: 'wrap' }}>
            <div style={{ position: 'relative', flex: '1', minWidth: '220px', maxWidth: '360px' }}>
              ...
              <input type="text" placeholder="Search vaccine, supplier, order ID..."
                ...
                style={{ width: '100%', padding: '8px 36px 8px 36px', borderRadius: '20px', border: '1.5px solid #e0e0e0', fontSize: '13px', outline: 'none', background: 'white', color: '#333', transition: 'border-color 0.2s', boxSizing: 'border-box', height: '38px' }}
