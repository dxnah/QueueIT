...
// NOTE: vaccineData is no longer hardcoded here.
// Both DemandForecast and DailyAnalytics now fetch live vaccine data
// from GET /api/vaccines/ via vaccineAPI.getAll().